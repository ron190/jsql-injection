...
public enum Interaction {
    ...
    MARK_BLIND_BINARY_INVULNERABLE("MarkBlindBinaryInvulnerable"),
    MARK_BLIND_BINARY_STRATEGY("MarkBlindBinaryStrategy"),
    MARK_BLIND_BINARY_VULNERABLE("MarkBlindBinaryVulnerable"),

...
public class CustomMethodSuiteIgnoreIT extends ConcreteMySqlErrorSuiteIT {
    ...
    public void setupInjection() throws Exception {
        ...
        model.getMediatorUtils().getParameterUtil().setListRequest(
            List.of(new SimpleEntry<>("name", ""))
        );

...
//    }
    ...
    public static final String REQUEST_METHOD_TOOLTIP = (String) CURRENT_LOCALE.getObject("requestMethodTooltip");
    ...
    public static final String REQUEST_METHOD = (String) CURRENT_LOCALE.getObject("requestMethod");

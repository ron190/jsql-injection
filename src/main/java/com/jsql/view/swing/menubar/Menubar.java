...
public class Menubar extends JMenuBar {
    ...
    public Menubar() {
        ...
        chunkMenu = new JCheckBoxMenuItem(
            ...
            new ImageIcon(Menubar.class.getResource("/com/jsql/view/swing/resources/images/chunk.gif")), 
        ...
        binaryMenu = new JCheckBoxMenuItem(
            ...
            new ImageIcon(Menubar.class.getResource("/com/jsql/view/swing/resources/images/binary.gif")), 
        ...
        networkMenu = new JCheckBoxMenuItem(
            ...
            new ImageIcon(Menubar.class.getResource("/com/jsql/view/swing/resources/images/header.gif")), 
            prefs.getBoolean(HelperGUI.NETWORK_VISIBLE, true)
        );
        menuPanel.add(networkMenu);
        javaDebugMenu = new JCheckBoxMenuItem(
            I18n.JAVA_TAB_LABEL, 
            new ImageIcon(Menubar.class.getResource("/com/jsql/view/swing/resources/images/cup.png")), 
        ...
        final Map<JMenuItem, Integer> p = new HashMap<>();
        p.put(database, 0);
        p.put(adminPage, 1);
        p.put(file, 2);
        p.put(webshell, 3);
        ...
        for (final JMenuItem m: p.keySet()) {
            m.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent arg0) {
                    MediatorGUI.tabManagers().setSelectedIndex(p.get(m));
                }
            });
        }
        ...
        preferences.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (!prefDiag.isVisible()) {
                    ...
                    prefDiag.setLocationRelativeTo(MediatorGUI.jFrame());

...
//    public static final Color SELECTION_BACKGROUND = new Color(211, 230, 255);
    ...
    public static final Icon TICK = new ImageIcon(HelperGUI.class.getResource("/com/jsql/view/images/check.png"));
    public static final Icon SQUARE_RED = new ImageIcon(HelperGUI.class.getResource("/com/jsql/view/images/squareRed.png"));
    public static final Icon SQUARE_GREY = new ImageIcon(HelperGUI.class.getResource("/com/jsql/view/images/squareGrey.png"));
    public static final Icon LOADER_GIF = new ImageIcon(HelperGUI.class.getResource("/com/jsql/view/images/spinner.gif"));

    public static final Icon ADMIN_SERVER_ICON = new ImageIcon(HelperGUI.class.getResource("/com/jsql/view/images/adminServer.png"));
    public static final Icon SHELL_SERVER_ICON = new ImageIcon(HelperGUI.class.getResource("/com/jsql/view/images/shellServer.png"));
    public static final Icon DATABASE_SERVER_ICON = new ImageIcon(HelperGUI.class.getResource("/com/jsql/view/images/databaseServer.png"));
    public static final Icon FILE_SERVER_ICON = new ImageIcon(HelperGUI.class.getResource("/com/jsql/view/images/fileServer.png"));
    public static final Icon BRUTER_ICON = new ImageIcon(HelperGUI.class.getResource("/com/jsql/view/images/lock.png"));
    public static final Icon CODER_ICON = new ImageIcon(HelperGUI.class.getResource("/com/jsql/view/images/coder.png"));
    public static final Icon UPLOAD_ICON = new ImageIcon(HelperGUI.class.getResource("/com/jsql/view/images/server_add.png"));
    public static final Icon TABLE_ICON = new ImageIcon(HelperGUI.class.getResource("/com/jsql/view/images/table.png"));
...
//        UIManager.put("Button.toolBarBorderBackground", Color.RED);
        ...
        int red = (int) Math.round(Math.min(255, SELECTION_BACKGROUND.getRed() + 255 * 0.05f));
        ...
        UIManager.put("CheckBoxMenuItem.checkIcon", new ImageIcon(HelperGUI.class.getResource("/com/jsql/view/images/check.png")) {
            @Override
...
//        UIManager.put("ScrollBar.squareButtons", true);
        ...
        // Custom tree
        UIManager.put("Tree.expandedIcon", new ImageIcon(HelperGUI.class.getResource("/com/jsql/view/images/expanded.png")));
        UIManager.put("Tree.collapsedIcon", new ImageIcon(HelperGUI.class.getResource("/com/jsql/view/images/collapsed.png")));
    ...
    public static List<Image> getIcons() {
        ...
        URL urlSmall = HelperGUI.class.getResource("/com/jsql/view/images/app-16x16.png");
        URL urlBig = HelperGUI.class.getResource("/com/jsql/view/images/app-32x32.png");
        try {

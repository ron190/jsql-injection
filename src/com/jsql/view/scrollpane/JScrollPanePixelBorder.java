...
public class JScrollPanePixelBorder extends JScrollPane {
    ...
    public JScrollPanePixelBorder(Component c) {
        ...
        this.setBorder(BorderFactory.createMatteBorder(1, 1, 0, 0, ToolsGUI.COMPONENT_BORDER));
        this.setViewportBorder(BorderFactory.createMatteBorder(1, 1, 0, 0, ToolsGUI.COMPONENT_BORDER));
    }
    ...
    public JScrollPanePixelBorder(int top, int left, int bottom, int right, Component c) {
        ...
        this.setBorder(BorderFactory.createMatteBorder(top, 0, bottom, 0, ToolsGUI.COMPONENT_BORDER));
        this.setViewportBorder(BorderFactory.createMatteBorder(0, left, 0, right, ToolsGUI.COMPONENT_BORDER));
    }
}

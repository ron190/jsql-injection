...
public final class GUITools {
    ...
    public static final Icon LOADER_GIF = new ImageIcon(GUITools.class.getResource("/com/jsql/view/images/spinner.gif"));

    public static final Icon ADMIN_SERVER_ICON = new ImageIcon(GUITools.class.getResource("/com/jsql/view/images/adminServer.png"));
    public static final Icon SHELL_SERVER_ICON = new ImageIcon(GUITools.class.getResource("/com/jsql/view/images/shellServer.png"));
    public static final Icon DATABASE_SERVER_ICON = new ImageIcon(GUITools.class.getResource("/com/jsql/view/images/databaseServer.png"));
    public static final Icon FILE_SERVER_ICON = new ImageIcon(GUITools.class.getResource("/com/jsql/view/images/fileServer.png"));
    public static final Icon BRUTER_ICON = new ImageIcon(GUITools.class.getResource("/com/jsql/view/images/lock.png"));
    public static final Icon CODER_ICON = new ImageIcon(GUITools.class.getResource("/com/jsql/view/images/coder.png"));
...
//        UIManager.put("ScrollBar.squareButtons", true);
        ...
        UIManager.put("ComboBox.border", GUITools.BLU_ROUND_BORDER);
        UIManager.put("TextField.border", GUITools.BLU_ROUND_BORDER);

...
public class TopPanel extends JPanel {
    ...
    public TopPanel() {
        ...
        submitAddressBar.setToolTipText("<html>Start injection</html>");
    ...
    private class ActionStart implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if ("Connect".equals(submitAddressBar.state)) {
                int option = 0;
            ...
            } else if ("Stop".equals(submitAddressBar.state)) {

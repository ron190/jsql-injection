...
public class LeftRightBottomPanel extends JSplitPaneWithZeroSizeDivider{
    ...
    public final String VERTICALSPLITTER_PREFNAME = "verticalSplitter-" + InjectionModel.JSQLVERSION;
    public final String HORIZONTALSPLITTER_PREFNAME = "horizontalSplitter-" + InjectionModel.JSQLVERSION;

...
public final class ToolsGUI {
     ...
     */
    private static final Logger LOGGER = Logger.getLogger(ToolsGUI.class);
    ...
    public static final Icon TICK = new ImageIcon(ToolsGUI.class.getResource("/com/jsql/view/images/check.png"));
    public static final Icon SQUARE_RED = new ImageIcon(ToolsGUI.class.getResource("/com/jsql/view/images/squareRed.png"));
    public static final Icon SQUARE_GREY = new ImageIcon(ToolsGUI.class.getResource("/com/jsql/view/images/squareGrey.png"));
    public static final Icon LOADER_GIF = new ImageIcon(ToolsGUI.class.getResource("/com/jsql/view/images/spinner.gif"));

    public static final Icon ADMIN_SERVER_ICON = new ImageIcon(ToolsGUI.class.getResource("/com/jsql/view/images/adminServer.png"));
    public static final Icon SHELL_SERVER_ICON = new ImageIcon(ToolsGUI.class.getResource("/com/jsql/view/images/shellServer.png"));
    public static final Icon DATABASE_SERVER_ICON = new ImageIcon(ToolsGUI.class.getResource("/com/jsql/view/images/databaseServer.png"));
    public static final Icon FILE_SERVER_ICON = new ImageIcon(ToolsGUI.class.getResource("/com/jsql/view/images/fileServer.png"));
    public static final Icon BRUTER_ICON = new ImageIcon(ToolsGUI.class.getResource("/com/jsql/view/images/lock.png"));
    public static final Icon CODER_ICON = new ImageIcon(ToolsGUI.class.getResource("/com/jsql/view/images/coder.png"));
    public static final Icon UPLOAD_ICON = new ImageIcon(ToolsGUI.class.getResource("/com/jsql/view/images/server_add.png"));
    public static final Icon TABLE_ICON = new ImageIcon(ToolsGUI.class.getResource("/com/jsql/view/images/table.png"));
...
//        UIManager.put("PopupMenu.border", BorderFactory.createLineBorder(ToolsGUI.COMPONENT_BORDER));
        ...
        UIManager.put("CheckBoxMenuItem.checkIcon", new ImageIcon(ToolsGUI.class.getResource("/com/jsql/view/images/check.png")) {
            @Override
...
//        UIManager.put("ScrollBar.squareButtons", true);
        ...
        UIManager.put("ComboBox.border", ToolsGUI.BLU_ROUND_BORDER);
        UIManager.put("TextField.border", ToolsGUI.BLU_ROUND_BORDER);
        ...
        // Custom tree
        UIManager.put("Tree.expandedIcon", new ImageIcon(ToolsGUI.class.getResource("/com/jsql/view/images/expanded.png")));
        UIManager.put("Tree.collapsedIcon", new ImageIcon(ToolsGUI.class.getResource("/com/jsql/view/images/collapsed.png")));
    ...
    public static List<Image> getIcons() {
        ...
        URL urlSmall = ToolsGUI.class.getResource("/com/jsql/view/images/app-16x16.png");
        URL urlBig = ToolsGUI.class.getResource("/com/jsql/view/images/app-32x32.png");
        try {

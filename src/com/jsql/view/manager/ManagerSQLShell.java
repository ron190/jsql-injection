...
public class ManagerSQLShell extends ManagerAbstractList {
    /**
     * Log4j logger sent to view.
     */
    private static final Logger LOGGER = Logger.getLogger(ManagerSQLShell.class);
...
//                            .addComponent(mm)
        ...
        this.run.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                if (ManagerSQLShell.this.listPaths.getSelectedValuesList().isEmpty()) {
                ...
                for (final Object path: ManagerSQLShell.this.listPaths.getSelectedValuesList()) {

...
## Installation [[jsql-injection-v0.80.jar](https://github.com/ron190/jsql-injection/releases/download/v0.80/jsql-injection-v0.80.jar)]
Install [Java 8](http://java.com), then download the latest [release](https://github.com/ron190/jsql-injection/releases/) and double-click on the file `jsql-injection-v0.80.jar` to launch the software.<br>
You can also type `java -jar jsql-injection-v0.80.jar` in your terminal to start the program.<br>
